...
export class Settings extends Component<any> {
    ...
    constructor(app: App) {
        ...
        this.app.localization.set_element_text(title_element, "innerHTML", "SETTINGS");
        ...
        this.app.localization.set_element_text(this.btn_close, "innerHTML", "GO BACK");
        ...
        this.app.localization.set_element_text(settings_select.title_element, "innerHTML", `Language`);
        ...
        this.app.localization.set_element_text(this.dialogue_speed.text_element, "innerHTML", `Dialogue speed`);
        ...
        this.app.localization.set_element_text(this.dialogue_typing_sound_effect_enabled.text_element, "innerHTML", `Dialogue Typing Sound Effect`);
        ...
        this.app.localization.set_element_text(this.master_volume_slider.title_element, "innerHTML", `Master Volume`);
        ...
        this.app.localization.set_element_text(this.music_volume_slider.title_element, "innerHTML", `Music Volume`);
        ...
        this.app.localization.set_element_text(this.voice_volume_slider.title_element, "innerHTML", `Voice Volume`);
        ...
        this.app.localization.set_element_text(this.sound_effect_volume_slider.title_element, "innerHTML", `Sound Effect Volume`);
