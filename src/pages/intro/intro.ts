...
export class IntroPage extends Component<any> {
    ...
    constructor(app: App) {
        ...
        this.app.localization.set_element_text(this.description_element, "innerHTML", `Explore the XELIS Blockchain and its ecosystem. Earn rewards by completing educational quests.`);
        content.appendChild(this.description_element);

        this.btn_start_element = document.createElement(`button`);
        this.app.localization.set_element_text(this.btn_start_element, "innerHTML", "{} Start", [icons.play()])
